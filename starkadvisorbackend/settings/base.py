...
INSTALLED_APPS = [
    ...
    # tus apps reales (ajusta a las que existan en tu repo)
    "chatbot",
    "news",
    "stocks",
    "user_admin",
...
# ------------------------
# Prioriza DATABASE_URL; si no, usa DB_* con sslmode=require.
...
if DATABASE_URL:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DB_NAME", "starkadvisor_db"),
            "USER": env("DB_USER", ""),
...
# ------------------------
# Logging a consola (Azure Log Stream)
# ------------------------
LOGGING = {
    "version": 1,
    ...
    "loggers": {
        ...
        # quita "core" porque ya no existe esa app
        "chatbot": {"handlers": ["console"], "level": "INFO", "propagate": True},
        "news": {"handlers": ["console"], "level": "INFO", "propagate": True},
        "stocks": {"handlers": ["console"], "level": "INFO", "propagate": True},
        "user_admin": {"handlers": ["console"], "level": "INFO", "propagate": True},
    },
}
